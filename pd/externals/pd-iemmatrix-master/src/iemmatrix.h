...
/* basic I/O functions */
void matrix_bang(t_object *x,
                 t_matrix *m); /* output the matrix stored in atombuffer */
void matrix_matrix2(void *x, t_matrix *m, int argc,
...
#if KERNEL_VERSION(PD_VERSION_MAJOR, PD_VERSION_MINOR, PD_VERSION_BUGFIX) <    \
