...
{
  mtx_distance2_class =
      class_new(gensym("mtx_distance2"), (t_newmethod)mtx_distance2_new,
                (t_method)mtx_binmtx_free, sizeof(t_mtx_binmtx), 0, A_NULL, 0);
...
void iemtx_distance2_setup(void) { mtx_distance2_setup(); }
