...
/*-----------------------------------------------------------------------------------------------------------------------------*/
void IEMCONVOLVE(addArray)(const t_float* array1, const t_float* array2,
                           int len, t_float* result)
{
  for (int i = 0; i < len; i++)
...
/*-----------------------------------------------------------------------------------------------------------------------------*/
void IEMCONVOLVE(unitImpulse3D)(t_float*** x, int len1, int len2, int len3,
                                int m, int n, int o)
{
...
/*-----------------------------------------------------------------------------------------------------------------------------*/
void IEMCONVOLVE(OneImpulse3D)(t_float*** x, int len1, int len2, int len3,
                               int m, int n)
{
  IEMCONVOLVE(reset3DArray)(x, len1, len2, len3);
  if ((m < len1) && (n < len2)) {
...
/*-----------------------------------------------------------------------------------------------------------------------------*/
void IEMCONVOLVE(copyComplexArray)(const t_complex* src, t_complex* dst,
                                   int len)
{
  for (int i = 0; i < len; i++) {
    dst[i].re = src[i].re;
...
/*-----------------------------------------------------------------------------------------------------------------------------*/
void IEMCONVOLVE(copy2DArray)(const t_float** src, t_float** dst, int channels,
...
void IEMCONVOLVE(copyExcerpt)(const t_float* src, t_float* dst, int src_offset,
...
/*-----------------------------------------------------------------------------------------------------------------------------*/
void IEMCONVOLVE(copyArrayWithGain)(const t_float* src, t_float* dst, int len,
                                    t_float gain)
{
  for (int i = 0; i < len; i++) {
    dst[i] = src[i] / gain;
...
/*-----------------------------------------------------------------------------------------------------------------------------*/
void IEMCONVOLVE(reset3DComplexArray)(t_complex*** in, int len1, int len2,
                                      int len3)
{
  for (int i = 0; i < len1; i++) {
...
/*-----------------------------------------------------------------------------------------------------------------------------*/
void IEMCONVOLVE(reset4DComplexArray)(t_complex**** in, int len1, int len2,
                                      int len3, int len4)
{
  for (int i = 0; i < len1; i++) {
...
/*-----------------------------------------------------------------------------------------------------------------------------*/
void IEMCONVOLVE(reset5DComplexArray)(t_complex***** in, int len1, int len2,
...
/*-----------------------------------------------------------------------------------------------------------------------------*/
void IEMCONVOLVE(freq_mul_acc)(const t_complex* array1, const t_complex* array2,
                               t_complex* result, int len)
{
  for (int i = 0; i < len; i++) {
...
/*-----------------------------------------------------------------------------------------------------------------------------*/
t_float IEMCONVOLVE(squared2DError)(const t_float** x, const t_float** y,
                                    int len1, int len2)
{
  t_float error = 0;
  for (int i = 0; i < len1; i++) {
...
/*free memory*/
/*-----------------------------------------------------------------------------------------------------------------------------*/
void IEMCONVOLVE(free1DComplexArray)(t_complex* x) { iemfft_free(x); }
...
void IEMCONVOLVE(free5DComplexArray)(t_complex***** x, int I, int J, int K,
                                     int L)
{
  for (int i = 0; i < I; i++)
...
void IEMCONVOLVE(free1DArray)(t_float* x) { iemfft_free(x); }
