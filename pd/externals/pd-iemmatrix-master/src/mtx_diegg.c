...
{
  mtx_diegg_class =
      class_new(gensym("mtx_diegg"), (t_newmethod)mtx_diegg_new,
  ...
  class_addmethod(mtx_diegg_class, (t_method)mtx_diegg_matrix, gensym("matrix"),
                  A_GIMME, 0);
}
void iemtx_diegg_setup(void) { mtx_diegg_setup(); }
